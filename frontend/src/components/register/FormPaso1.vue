<script setup>
defineProps(["nombre", "email", "errorNombre", "errorEmail"]);
defineEmits(["update:nombre", "update:email"]);
</script>

<template>
  <!-- nombre  -->
  <div class="flex flex-col w-full">
    <span class="font-semibold border-l-4 border-blue-400 leading-none pl-2 pb-0.5"> Nombre </span>
    <input
      :value="nombre"
